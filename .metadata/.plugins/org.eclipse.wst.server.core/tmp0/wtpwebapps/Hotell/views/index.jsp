...
<head>
    ...
    @import url('https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap');
        ...
        * {
        ...
        .form-group {
            flex: 1 1 calc(50% - 20px); /* Each form group takes up 50% of the width */
            display: flex;
    ...
    border: 1px solid var(--border-color);
    border-radius: 10px;
    color: var(--text-primary); /* Assurez-vous que la couleur du texte est claire */
    font-size: 1rem;
    outline: none;
}

select option {
    color: #333; /* Couleur de texte des options */
