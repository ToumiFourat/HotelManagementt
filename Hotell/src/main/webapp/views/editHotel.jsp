...
<body>
    <div class="form-container">
        <h1 class="form-title">Modifier un Hôtel</h1>
    ...
    required
>
    <option value="" disabled ${param.city == null ? 'selected' : ''}>Villes</option>
    <option value="ZARZIS" ${param.city == 'standard' ? 'selected' : ''}>ZARZIS</option>
    <option value="ARIANA" ${param.city == 'deluxe' ? 'selected' : ''}>ARIANA</option>
    <option value="MONASTIR" ${param.city == 'suite' ? 'selected' : ''}>MONASTIR</option>
    <option value="SOUSSE" ${param.city == 'suite' ? 'selected' : ''}>SOUSSE</option>
</select>
